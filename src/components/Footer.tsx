            ...
            <div className="container">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
                    ...
                    <div className="flex-col" style={{ gap: '1.5rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', fontSize: '1.5rem' }}>
                            ...
                            <a href="https://facebook.com/healingsbyshilpi" target="_blank" rel="noreferrer" title="Facebook" style={{ filter: 'grayscale(1)' }}>👥</a>
                ...
                <div style={{ borderTop: '1px solid var(--border-light)', paddingTop: '2rem', textAlign: 'center', color: 'var(--fg-secondary)', fontSize: '0.8rem' }}>
                    ...
                    <div style={{ marginTop: '1rem', fontSize: '0.75rem' }}>
                        {t('footer.poweredBy')} <a href="http://www.mindproedge.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)', fontWeight: '500', textDecoration: 'none' }}>Mindpro Edge</a>
                    </div>
                </div>
            </div>
        </footer>
